...
export const FacebookIcon = ({ size = 24, ...props }: IconProps) => (
  ...
  >
    <path
      d="M24 12.073c0-5.8-4.698-10.5-10.497-10.5s-10.5 4.7-10.5 10.5c0 5.23 3.798 9.566 8.759 10.359v-7.322h-2.636v-3.037h2.636V9.41c0-2.603 1.55-4.039 3.923-4.039 1.136 0 2.323.204 2.323.204v2.55h-1.308c-1.29 0-1.692.8-1.692 1.622v1.945h2.88l-.46 3.036h-2.42v7.323C20.2 21.639 24 17.303 24 12.073z"
      fill="currentColor"
    />
  </svg>
)
...
export const TwitterIcon = ({ size = 24, ...props }: IconProps) => (
  ...
  >
    <path
      d="M23 3.01a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1a10.66 10.66 0 01-9-4.53s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5 0-.278-.028-.556-.08-.83A7.72 7.72 0 0023 3.01z"
      fill="currentColor"
    />
  </svg>
)
...
export const CommentIcon = ({ size = 24, ...props }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const ChurchIcon = ({ size = 24, ...props }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
