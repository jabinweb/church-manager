      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center">
            <Link href="/" className="flex-shrink-0 flex items-center group mr-8" prefetch={false}>
              {logoUrl ? (
                <span className="relative h-10 w-10 mr-3 flex items-center justify-center">
                  <Image
                    src={logoUrl}
                ...
                <Church className="h-8 w-8 text-purple-600 mr-3 group-hover:text-purple-700 transition-colors" />
              )}
              <div className="flex flex-col">
                <span className="text-xl font-bold text-gray-900 leading-tight">{mainName}</span>
                {subName && (
            ...
            {session ? (
              <>
                ...
                <div className="relative" ref={userMenuRef}>
                  ...
                  {showUserMenu && (
                    <div className="absolute right-0 mt-1 w-56 bg-white rounded-lg shadow-lg py-2 border border-gray-100 z-20">
              ...
              <div className="flex items-center space-x-2">
                ...
                <Button className="bg-purple-600 hover:bg-purple-700 text-sm h-9 px-4" asChild>
      ...
      {isOpen && (
        <div className="lg:hidden border-t border-gray-100">
          <div className="px-4 py-3 space-y-1 bg-white max-h-[80vh] overflow-y-auto">
                    ...
                    {item.hasDropdown ? (
                      <div>
                        <button
                          ...
                          className="flex items-center justify-between w-full px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-purple-600 hover:bg-gray-50"
                        >
                          <div className="flex items-center">
            ...
            {/* Sign In / Give buttons for mobile */}
            {!session && (
              <div className="pt-4 mt-4 border-t border-gray-200 space-y-2">
                <Link
                  href="/auth/signin"
                  className="block px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-purple-600 hover:bg-gray-50 transition-colors"
                  onClick={() => setIsOpen(false)}
                >
                  Sign In
                </Link>
                <Link
                  href="/giving"
                  className="block px-3 py-2 rounded-md text-sm font-medium bg-purple-600 text-white hover:bg-purple-700 transition-colors"
                  onClick={() => setIsOpen(false)}
                >
                  Give Now
                </Link>
