  ...
  const mainNavGroups: NavGroup[] = [
    {
      ...
      items: [
        ...
        { 
          ...
          icon: Users,
          hasDropdown: true,
          dropdownItems: ministries.length > 0 
            ? ministries.map(ministry => ({
                name: ministry.name,
                href: `/ministries/${ministry.slug || generateSlug(ministry.name)}`
              }))
            : [
                { name: 'View All Ministries', href: '/ministries' },
              ]
        },
                      ...
                      <div key={item.name} className="relative group/nested">
                        {item.hasDropdown ? (
                          <>
                            ...
                            {item.dropdownItems && (
                              <div className="absolute left-full top-0 ml-1 w-56 bg-white rounded-lg shadow-lg py-2 border border-gray-100 hidden group-hover/nested:block">
